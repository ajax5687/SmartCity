...
d3.tsv("data/data.tsv", function(error, data) {
  ...
  stack(dataByGroup);
  x.domain(dataByGroup[0].values.map(function(d) { return d.city; }));
  ...
  var group = svg.selectAll(".group")
   ...
   group.append("text")
      .attr("class", "label")
      .attr("x", -6)
      .attr("y", function(d) { return y1(d.values[0].cost / 2); })
      .attr("dy", ".35em")
  ...
  group.selectAll("rect")
    ...
    .enter().append("rect")
      ...
      .attr("class", function(d){ return "bar " + convertToSlug(d.category)})
  ...
  function transitionMultiples() {
    ...
    g.select(".label")//.attr("y", function(d) { return y1(d.values[0].cost / 2); })
                      .style({'opacity': '0.8'});
     hideAnnotation();
  }
  ...
  function transitionStacked() {
    ...
    g.selectAll("rect").attr("y", function(d) { return y1(d.cost + d.valueOffset); });
    g.select(".label")//.attr("y", function(d) { return y1(d.values[0].cost / 2 + d.values[0].valueOffset); })
                      .style({'opacity': '0'});
     showAnnotation();
  }
});
